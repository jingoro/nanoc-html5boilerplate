...
A nanoc skeleton project that incorporates [nanoc v3.4.1](http://nanoc.stoneship.org/), [HTML5 Boilerplate v4.0](http://html5boilerplate.com/) and much more (see below) to get you started right.
